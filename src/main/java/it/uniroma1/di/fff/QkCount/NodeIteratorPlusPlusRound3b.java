...
public class NodeIteratorPlusPlusRound3b extends AbstractRound implements Tool {	

	boolean useLazyPairs;
	
	public NodeIteratorPlusPlusRound3b(boolean useLazyPairs) {
		super();
